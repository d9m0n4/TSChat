        ...
        <>
          {conversation && (
            <AddDialogModal
              ...
              <Input required={true} value={conversation.title} disabled />
              <div className="add-dialog-form-btn">
                <Button disabled={!convUsers} shape="round" onClick={updateConversation}>
                  Добавить
                </Button>
              </div>
            </AddDialogModal>
                    ...
                    <div className="rightbar__body rightbar__conversation">
                      <>
                        <div className="rightbar__conversation-header">
                          <div className="rightbar__conversation-header-title">
                            Участиники беседы
                          </div>
