...
const Message = ({ isMe, name, text, date, attachments, user, serverMessage  }) => {
  ...
  return (
      ...
      <>{serverMessage ? <div className='server__message'>
        <span></span><p>{text}</p><span></span>
      </div> : <div className={classNames('message', {'message--isme': isMe})}>
        <div className="message__avatar">
          <UserAvatar name={name} size={36} src={user.userAvatar && user.userAvatar}/>
        </div>
